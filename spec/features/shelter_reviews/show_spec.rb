...
RSpec.describe "Shelter Reviews" do
  it "shows all of the particular shelter's reviews on its show page" do
    ...
    review_2 = ShelterReview.create!(title: "Pretty Good Owl!", rating: 4, content: "I got a pretty good owl and I still have most of my face.", image: "", shelter_id: shelter_1.id)
